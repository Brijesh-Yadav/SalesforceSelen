...
public class LexTextFieldRepo extends CommonRepoFun{
	...
	public static ArrayList<String> pattern(String object_name, int index, int patternIndex){
		...
		obj_list.add("(//input[@id=\""+object_name+"\"])["+getIndex(index)+"]");
		obj_list.add("(//input[@class=\""+object_name+"\"])["+getIndex(index)+"]");
